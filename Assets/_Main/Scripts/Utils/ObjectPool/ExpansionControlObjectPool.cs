...
public class ExpansionControlObjectPool<T> where T : MonoBehaviour
{
    ...
    public ExpansionControlObjectPool(T prefab, bool autoExpand, Transform container, int amount)
    {
        Prefab = prefab;
